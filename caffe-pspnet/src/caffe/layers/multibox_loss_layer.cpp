...
//  std::cout << "nan counts in loc_data =  ";
//  for(int i=0;i< ((Blob<Dtype>*)bottom[0])->count();i++)
//      if(isnan(loc_data[i]))
//              nan_count++;//std::cout << loc_data[i] << "  ";
//  std::cout << nan_count << "\n";

//  nan_count =0;

//  std::cout << "nan counts in conf_data =  ";
//  for(int i=0;i< ((Blob<Dtype>*)bottom[1])->count();i++)
//      if(isnan(conf_data[i]))
//              nan_count++;//std::cout << conf_data[i] << "  ";
//  std::cout << nan_count << "\n";
